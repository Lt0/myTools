...
IMG=trusty-deb-cacher

show_help() {
echo "
$IMG is a tool for downloading ubuntu 14.04 deb packages with dependencies. All downloaded deb packaeges will be saved in <package_name> dir.
